...
class UltraSonic
{
   ...
   UltraSonic(byte triggerPin,byte echoPin,unsigned short maxDistanceCm=80,unsigned short maxTimeoutMicroSec=0)
   ...
   float distance()
   {
    ...
    digitalWrite(triggerPin, LOW);
    float speedOfSoundInCmPerMicroSec = 0.03313 + 0.0000606 * 19.307;
