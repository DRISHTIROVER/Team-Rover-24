...
public:
    ...
    {
        tile_map_config->setWindowTitle(QApplication::translate("tile_map_config", "Form", nullptr));
        url_label->setText(QApplication::translate("tile_map_config", "Base URL:", nullptr));
        label->setText(QApplication::translate("tile_map_config", "Source:", nullptr));
        status->setText(QApplication::translate("tile_map_config", "Unconfigured", nullptr));
        label_6->setText(QApplication::translate("tile_map_config", "Max Zoom:", nullptr));
        reset_cache_button->setText(QApplication::translate("tile_map_config", "Reset Cache", nullptr));
        source_combo->setItemText(0, QApplication::translate("tile_map_config", "Stamen (terrain)", nullptr));
        source_combo->setItemText(1, QApplication::translate("tile_map_config", "Stamen (watercolor)", nullptr));
        source_combo->setItemText(2, QApplication::translate("tile_map_config", "Stamen (toner)", nullptr));
        source_combo->setItemText(3, QApplication::translate("tile_map_config", "Bing Maps (terrain)", nullptr));
        source_combo->setItemText(4, QApplication::translate("tile_map_config", "Custom WMTS Source...", nullptr));

        base_url_text->setText(QApplication::translate("tile_map_config", "http://tile.stamen.com/terrain/", nullptr));
        delete_button->setText(QApplication::translate("tile_map_config", "Delete", nullptr));
        save_button->setText(QApplication::translate("tile_map_config", "Save...", nullptr));
        label_2->setText(QApplication::translate("tile_map_config", "Status:", nullptr));
    } // retranslateUi
