...
echo_and_run cd "/home/rover_1/rover_new/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rover_1/rover_new/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/rover_1/rover_new/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
