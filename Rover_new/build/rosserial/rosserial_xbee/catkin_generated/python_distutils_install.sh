...
echo_and_run cd "/home/rover_1/rover_new/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/rover_1/rover_new/src/rosserial/rosserial_xbee/setup.py" \
     \
    build --build-base "/home/rover_1/rover_new/build/rosserial/rosserial_xbee" \
    install \
    --root="${DESTDIR-/}" \
