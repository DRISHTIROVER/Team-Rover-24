...
if("TRUE" STREQUAL "TRUE")
  set(nmea_navsat_driver_SOURCE_PREFIX /home/rover_1/rover_new/src/nmea_navsat_driver)
  set(nmea_navsat_driver_DEVEL_PREFIX /home/rover_1/rover_new/devel)
  ...
  set(nmea_navsat_driver_INSTALL_PREFIX /home/rover_1/rover_new/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'tir <tir@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nmea_navsat_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rover_1/rover_new/src/nmea_navsat_driver/${idir}'.  ${_report}")
    endif()
